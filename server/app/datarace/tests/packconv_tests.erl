...
pack_test(_SetupData) ->
    ...
    MatchStats = [{match_stats_table, 1, <<"maz">>, 2, 3, 4, 12345.12345, 5},
		  {match_stats_table, 1, <<"maz">>, 2, 3, 4, 12345.12345, 5}],
    ...
    GH = <<?GET_HISTORY_REPLY/binary,
	   1:32/little-integer, <<"maz">>/binary, 0:(47*8), 2:32/little-integer, 
	   3:32/little-integer, 4:32/little-integer,
	   12345.12345/little-float, 5:32/little-integer,
	   1:32/little-integer, <<"maz">>/binary, 0:(47*8), 2:32/little-integer, 
	   3:32/little-integer, 4:32/little-integer,
	   12345.12345/little-float, 5:32/little-integer>>,
    MS = <<?MATCH_STOP_REPLY/binary,
	   1:32/little-integer, <<"maz">>/binary, 0:(47*8), 2:32/little-integer, 
	   3:32/little-integer, 4:32/little-integer,
	   12345.12345/little-float, 5:32/little-integer,
	   1:32/little-integer, <<"maz">>/binary, 0:(47*8), 2:32/little-integer, 
    ...
    [?_assertEqual({RLM, RLC}, packconv:pack(?REQUEST_LOOKUP, RequestTable)),
     ...
     ?_assertEqual(GH, packconv:pack(?GET_HISTORY, MatchStats)),
     ?_assertEqual(MS, packconv:pack(?MATCH_STOP, MatchStats))].
