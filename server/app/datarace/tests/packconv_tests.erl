...
pack_test(_SetupData) ->
    ...
    MatchStats = [{match_stats_table, 1, 2, 3, 4, 12345.12345, 5},
		  {match_stats_table, 1, 2, 3, 4, 12345.12345, 5}],
    ...
    GH = <<?GET_HISTORY_REPLY/binary,
	   1:32/little-integer, 2:32/little-integer, 3:32/little-integer, 4:32/little-integer,
